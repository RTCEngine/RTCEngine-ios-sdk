...
NSString *const kRTCBeautyFilterFragmentShaderString = SHADER_STRING
(
...
-(id)init
{
    ...
    if (!(self = [super initWithFragmentShaderFromString:kRTCBeautyFilterFragmentShaderString])) {
        return nil;
    }
...
- (void)setParams:(CGFloat)beauty tone:(CGFloat)tone {
    ...
    fBeautyParam.one = 1.0 - 0.7 * beauty;
    fBeautyParam.two = 1.0 - 0.4 * beauty;
    fBeautyParam.three = 0.2 + 0.4 * tone;
    fBeautyParam.four = 0.2 + 0.4 * tone;
